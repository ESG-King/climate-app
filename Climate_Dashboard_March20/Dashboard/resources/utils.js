...
var options = {
    ...
    title: {
        text:'Climate Readiness Insight Score',
        style: {
            color:'white',
        }
    },
...
function renderDoubleBarChartCompanies() {
  ...
  series: [{
    name: 'Company',
    data: [49.9, 71.5, 55.4, 45.2, 56.0, 34.0, 45.6, 45.5, 32.4, 54.1, 70.6],


  }, {
    name: 'Peer Average',
    data: [39.6, 78.8, 58.5, 63.4, 66.0, 44.5, 45.0, 64.3, 71.2, 43.5, 86]
...
function renderPIEChartCompanies() {
  Highcharts.chart('pie-container', {
    chart: {
      plotBackgroundColor: '#252528',
    ...
    title: {
      text: 'GHG Emission Breakdown FY2020',
      style: {
        color:'white',
    }     
    },
